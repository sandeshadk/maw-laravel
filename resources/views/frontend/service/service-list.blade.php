	            ...
	            <div class="col-sm-6">
	                <nav aria-label="breadcrumb">
	                  <ol class="breadcrumb justify-content-sm-end">
	                    ...
	                    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('trainings',$brands->brand)}}">{{$brands->title}}</a></li>
	                  </ol>
	                </nav>
	            </div>
	        </div>
		        			...
		        			<div class="content_box new_content radius_all_10 box_shadow1 animation " data-animation="fadeInUp" data-animation-delay="0.0{{$count}}s" style="width: 350px; ,height: 420px;" >
			                    ...
			                    <div class="content_desc content_text">
			                        ...
			                        <div class="enroll_btn">
		                            	<a href="{{route('trainings',[$brands->brand,$data->slug])}}" class="btn btn-default btn-sm">Read More</a>
		                        	</div>
			                    </div>
