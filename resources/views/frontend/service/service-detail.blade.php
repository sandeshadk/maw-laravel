	            ...
	            <div class="col-sm-6">
	                <nav aria-label="breadcrumb">
	                  <ol class="breadcrumb justify-content-sm-end">
	                    ...
	                    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('trainings',[$brands->brand,$service->slug])}}">{{$service->title}}</a></li>
	                  </ol>
	                </nav>
	            </div>
	        </div>
                            ...
                            <ul class="recent_post border_bottom_dash list_none">
                                ...
                                <li>
                                    <div class="post_footer">
                                        <div class="post_img">
                                            <a href="{{route('trainings',$data->slug)}}"><img src="{{asset($data->image->path)}}" alt="letest_post1"></a>
                                        </div>
                                        <div class="post_content">
                                            <h6><a href="{{route('trainings',[$brands->brand,$data->slug])}}">{{$data->title}}</a></h6>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
